...
public class ChannelController {
    ...
    public ApiResponse<List<ChannelListResponse>> getChannels(
        ...
        return ApiResponse.ok(channelQueryService.getChannels(workspaceId, SecurityUtils.getCurrentUserId()));
    }
    ...
    public ApiResponse<ChannelListResponse> updateChannel(
        ...
        return ApiResponse.ok(channelCommandService.updateChannel(workspaceId, channelId, SecurityUtils.getCurrentUserId(), request));
    }
    ...
    public void deleteChannel(
        ...
        channelCommandService.deleteChannel(workspaceId, channelId, SecurityUtils.getCurrentUserId());
    }
}
